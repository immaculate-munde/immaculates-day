  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center px-4 py-16 overflow-hidden">
      ...
      <div className="relative z-10 text-center mb-10 flex flex-col items-center gap-3">
        ...
        <h1
          ...
          style={{
            ...
            color: '#4A6B3A',
            textShadow: '0 2px 20px rgba(100,150,80,0.2)',
          }}
        >
          Happy Birthday,
        </h1>
        <h1
          ...
          style={{
            fontFamily: 'var(--font-dancing-script)',
            color: '#C8716A',
            textShadow: '0 2px 20px rgba(200,113,106,0.25)',
          }}
        >
          Immaculate! 🎂
        </h1>
        ...
        <p
          className="text-lg sm:text-xl max-w-xs sm:max-w-sm text-center leading-relaxed"
          style={{ fontFamily: 'var(--font-dancing-script)', color: '#7A8E6A' }}
        >
      ...
      <div className="relative z-10 mt-8">
        <Link
          href="/board"
          className="transition-colors text-base underline underline-offset-4"
          style={{
            fontFamily: 'var(--font-dancing-script)',
            fontSize: '1.1rem',
            color: '#8A9E7A',
